...
contract HarmonyBridge is Ownable {
    ...
    function getRainbowSize() external view returns (uint256, uint256) {
    ...
    function receiptVerify(bytes memory rlpdata)
        private
    ...
    function onTokenMapAckEvent(bytes32[] memory topics, bytes memory Data)
        private
    {
        // event TokenMapAck(address indexed tokenReq, address indexed tokenAck);
        Data;
