...
const deployFunction: DeployFunction = async function (
    ...
    const faucetToken = await upgrades.deployProxy(FaucetToken, ['ONEHorizonFaucetToken', 'OHFT', 1000000], { initializer: 'initialize' })
    ...
    // console.log('FaucetToken deployed to:', faucetToken.address)
    // const tx = await faucetToken.initialize('ONEHorizonFaucetToken', 'OHFT', 1000000)
