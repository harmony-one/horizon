...
`yarn cli bcli ethRelay relay http://localhost:8545 http://localhost:9500 0x7e88a2e433222E4162d70Bfb02FB873c0c1cf508 -d ./src/cli/.dag`
...
- [ ] Resolve `ethash local wrong!` generated by `yarn cli ethRelay relay http://localhost:8545 http://localhost:9500 0x7e88a2e433222E4162d70Bfb02FB873c0c1cf508 -d ./src/cli/.dag` log can be found [here](https://gist.github.com/johnwhitton/3cfc746cb5e5cc5c469b6638f439dd3b)
