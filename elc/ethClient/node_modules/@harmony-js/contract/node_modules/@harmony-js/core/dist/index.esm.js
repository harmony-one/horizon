...
import { ResponseMiddleware, WSProvider, NewPendingTransactions, NewHeaders, LogSub, Syncing, Provider, HttpProvider, Messenger } from '@harmony-js/network';
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        switch (_b) {
                            ...
                            case 'hmy_getBlockByNumber': return [3 /*break*/, 8];
                        }
                        return [3 /*break*/, 10];
                    case 1:
                        {
                    ...
                    case 7:
                        ...
                        _c.label = 8;
                    case 8: return [4 /*yield*/, this.provider.send(newArgs, function (err, res) {
                            try {
                                if (err) {
                                    callback(err);
                                }
                    ...
                    case 9:
                        result = _c.sent();
                        return [2 /*return*/, this.resolveResult(result)];
                    case 10: return [4 /*yield*/, this.provider.send(newArgs, function (err, res) { return _this.resolveCallback(err, res, callback); })];
                    case 11:
                        result = _c.sent();
                        return [2 /*return*/, this.resolveResult(result)];
                }
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, this.messenger.send("hmy_getTransactionCount" /* GetTransactionCount */, [getAddress(extensionAccount.address).checksum, blockNumber], this.messenger.chainPrefix, typeof transaction.txParams.shardID === 'string'
                                        ? Number.parseInt(transaction.txParams.shardID, 10)
                                        : transaction.txParams.shardID)];
                            case 2:
                                nonce = _a.sent();
