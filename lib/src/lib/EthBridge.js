...
class EthBridge {
    constructor(tokenAddress, bridgeAddress) {
        ...
        if (tokenAddress) {
            ...
            console.log(" \n initialise EthBridge.js with erc token Address: "+ this.tokenAddress)
        } else {
        ...
        if (bridgeAddress) {
            ...
            console.log(" \n initialise EthBridge.js with bridgeAddress: "+ this.bridgeAddress)
        } else {
        ...
        console.log(' \n connecting to Ethereum chain: '+ process.env.ETH_NODE_URL)
    }
