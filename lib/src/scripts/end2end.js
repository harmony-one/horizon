...
async function eth2Hmy() {
    try {
        ...
        console.log(" \n balance after minting some erc20 token: ", mintBal)
        ...
        console.log(" \n lock token tx hash on ETH chain: ", lockedTxHash)
        ...
        console.log(amount + " amount transfer from erc20 to hrc20 succesfful ")
