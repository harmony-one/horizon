...
(async function() {
  let hash = "0xccafeb5a1350eb361186b1e019515d1c8cc45a7021ff94a20cd342fb90d1a6df";
  let local = new Web3(
    new Web3.providers.HttpProvider("http://localhost:9500")
  );
