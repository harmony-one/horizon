...
interface TesterEthereumLightClientInterface extends ethers.utils.Interface {
  functions: {
    ...
    "dummmyAddBlockHeader(uint256,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "dummmyAddBlockHeader",
...
export class TesterEthereumLightClient extends BaseContract {
  ...
  interface: TesterEthereumLightClientInterface;
  ...
  functions: {
    ...
    dummmyAddBlockHeader(
      parentHash: BigNumberish,
