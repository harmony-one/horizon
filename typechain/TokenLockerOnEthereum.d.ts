...
interface TokenLockerOnEthereumInterface extends ethers.utils.Interface {
  functions: {
    ...
    values: [
      {
        ...
        outgoingReceiptsRoot: BytesLike;
        incomingReceiptsRoot: BytesLike;
        logsBloom: BytesLike;
        number: BigNumberish;
        ...
        lastCommitSignature: BytesLike;
        lastCommitBitmap: BytesLike;
        vrf: BytesLike;
        vdf: BytesLike;
        shardState: BytesLike;
        crossLink: BytesLike;
        slashes: BytesLike;
        mmrRoot: BytesLike;
      },
...
export class TokenLockerOnEthereum extends BaseContract {
  ...
  interface: TokenLockerOnEthereumInterface;
